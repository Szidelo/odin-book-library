...
Book.prototype.getBookLength = function () {
	return `The book ${this.title} has ${this.pages}. Yes is a ${this.pages < 300 ? "short" : "long"} book`;
};
...
const theHobbit = new Book("The Hobbit", "J.R.R Tolkien", 256, STATUS.FINISHED, 256, "fantasy");
const theShining = new Book("The Shining", "Stephen King", 511, STATUS.QUEUE, 0, "horror");
const atomicHabits = new Book("Atomic Habits", "James Clear", 489, STATUS.QUEUE, 0, "personal development");
